...
var createReceive = function (t, cp) { return function (particle, source) {
    ...
    for (var i = 0; i < reactions.length; i++) {
        ...
        receive(cp.Log("Triggering Gene: " + geneName + " Particle: " + JSON.stringify(particle.meta), "Info"), organelle_nucleus_1.default.n);
...
exports.default = organelle_nucleus_1.default.com({
