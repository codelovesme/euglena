...
import { endoplasmicReticulum, attachOrganelle, getOrganelles, Sap as S, ccp } from "@euglena/template";

type EndoplasmicReticulum = endoplasmicReticulum.EndoplasmicReticulum;
type TransmitResponse = endoplasmicReticulum.TransmitResponse;
