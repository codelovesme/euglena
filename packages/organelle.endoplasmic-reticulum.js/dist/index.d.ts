import { OrganelleReceive, OrganelleModule } from "@euglena/organelle";
import { Particle } from "@euglena/particle";
declare const reticulumReceive: OrganelleModule<"EndoplasmicReticulum", import("@euglena/organelle").InsertSapIntoParticles<{
    incoming: {
    ...
    particles: Particle<string, unknown, {}>[];
    reticulumReceive: OrganelleReceive<Particle<string, unknown, {}>, Particle<string, unknown, {}>>;
}>>;
