...
exports.createOrganelleModule = function (name, createParticles, bindReactions) {
    var createOrganelle = function (transmit) { return function (particle) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            reaction = bindReactions[particle.meta.name];
            if (reaction) {
                t = transmit ? transmit.bind(undefined, name) : undefined;
                return [2 /*return*/, reaction(particle, {
                        transmit: t,
                        t: t,
...
exports.defineOrganelleModuleCreate = function (name, createParticles) { return ({
    n: name,
    name: name,
    createOrganelleModule: function (bindReactions) {
        var _a;
        return exports.createOrganelleModule(name, __assign(__assign({}, createParticles), { incoming: __assign(__assign({}, createParticles.incoming), (_a = {}, _a["Sap"] = common_1.ccp.Sap, _a)) }), bindReactions);
    },
