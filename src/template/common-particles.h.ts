...
export type OrganelleInfoLocationType = "FileSystemPath" | "NodeModules" | "Url";
/**
 * TODO:
 ...
 */
export type CreateCommonParticles = CreateParticles<{
  ...
  SaveParticle: (
    ...
    count?: Count,
    adds?: MetaAdditions
  ) => Particle<"SaveParticle", { particle: Particle; query?: sys.type.RecursivePartial<Particle>; count: Count }>;
  ReadParticle: (
    query: sys.type.RecursivePartial<Particle>,
    count?: Count,
    adds?: MetaAdditions
  ) => Particle<"ReadParticle", { query: sys.type.RecursivePartial<Particle>; count: Count }>;
  RemoveParticle: (
    query: sys.type.RecursivePartial<Particle>,
    count?: Count,
    adds?: MetaAdditions
  ) => Particle<"RemoveParticle", { query: sys.type.RecursivePartial<Particle>; count: Count }>;
  InvalidParticle: (adds?: MetaAdditions) => Particle<"InvalidParticle">;
}>;

export type CommonParticleType<PNU extends ParticleNameUnion<CreateCommonParticles>> = ParticleType<
  CreateCommonParticles,
  PNU
>;
