...
exports.logger = organelle_1.com("Logger", {
    incoming: {
        LoggerLog: function (message, level) { return particle_1.cp("LoggerLog", { message: message, level: level }); }
    },
    outgoing: {
    ...
    add("LoggerLog", function (particle, _a) {
        var r = _a.r, cp = _a.cp;
