...
exports.default = (0, core_1.dco)({
    Sap: function (p) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            sap = p.data;
            plantower = new plantower_1.default(sap.model, sap.path);
            return [2 /*return*/];
        });
    }); },
    Read: function (p) { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, plantower.read()];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, (0, core_1.cp)("Matter", [
