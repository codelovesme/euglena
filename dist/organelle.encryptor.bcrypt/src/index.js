...
exports.default = (0, core_1.dco)({
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _b = core_1.cp;
                        _c = ["Hash"];
                        return [4 /*yield*/, (0, bcrypt_1.hash)(data, saltRounds)];
    ...
    Decrypt: function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, (0, core_1.cp)("Exception", {
                    message: "Not supported!",
                })];
        });
    }); },
    Compare: function (_a) {
        var _b = _a.data, plain = _b.plain, hash = _b.hash;
        return __awaiter(void 0, void 0, void 0, function () {
            var _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        _c = core_1.cp;
                        _d = ["Boolean"];
                        return [4 /*yield*/, (0, bcrypt_1.compare)(plain.data, hash.data)];
