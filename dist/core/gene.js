...
exports.createChromosome = function (createOrganelleParticlesMap, bind) {
    var geneCluster = [];
    bind(function (name, triggers, reaction, adds) {
        ...
        var data = adds && adds.override ? { name: name, triggers: triggers, reaction: reaction, override: adds.override } : { name: name, triggers: triggers, reaction: reaction };
