...
import { OrganelleReceive, CreateOrganelleParticles, OutGoingParticleUnion, InComingParticleNameUnion, CreateParticles } from "./organelle.h";
...
export declare type CreateCytoplasmParticles = CreateParticles<{
