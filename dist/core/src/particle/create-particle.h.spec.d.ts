...
type Klm = Particle<"Klm", boolean, {
    version: string;
}>;
type Xyz = Particle<"Xyz", undefined, {
    version: string;
}>;
export type Result = [
    AssertTrue<Equals<CreateParticle<Abc>, (class_: "Abc") => Abc>>,
    AssertTrue<Equals<CreateParticle<Def>, (class_: "Def", data: boolean) => Def>>,
    AssertTrue<Equals<CreateParticle<Klm>, (class_: "Klm", data: boolean, adds: {
        version: string;
    }) => Klm>>,
    AssertTrue<Equals<CreateParticle<Xyz>, (class_: "Xyz", data: undefined, adds: {
        version: string;
    }) => Xyz>>,
...
export {};
//# sourceMappingURL=create-particle.h.spec.d.ts.map