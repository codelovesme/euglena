...
export type DefineCreateOrganelle = <COP extends OrganelleInteractions, I extends Interaction>(bindReactions: BindOrganelleReactions<InsertSapIntoParticles<COP, I>>) => CreateOrganelle;
import "./define-create-organelle.h.spec";
//# sourceMappingURL=define-create-organelle.h.d.ts.map