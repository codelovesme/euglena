...
type CP = ((class_: "AocResponse", data: boolean) => AocResponse) & ((class_: "Coc", data: boolean, adds: Omit<Meta<"Coc", {
    version: string;
}>, "class">) => Coc) & ((class_: "Doc") => Doc);
...
export type Result = [
    ...
    AssertSuper<Bind["Aoc"], (particle: Aoc, { t, cp }: {
        t: T;
        cp: CP;
    }) => Promise<AocResponse>>
];
export {};
//# sourceMappingURL=bind-reaction.h.spec.d.ts.map