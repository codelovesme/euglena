...
exports.default = (0, core_1.dco)({
    ...
    AddRoute: function (_a, _b) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                app[method]("".concat(path), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                    var resp;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, t(cp("HttpImpulse", {
                                    path: path,
                                    method: method,
    ...
    GetAlive: function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            app.listen(sap.port, function () { return console.log("app listening at ".concat(sap.port)); });
            return [2 /*return*/];
        });
    }); }
});
