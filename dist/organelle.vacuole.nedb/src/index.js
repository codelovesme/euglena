...
exports.default = (0, core_1.dco)({
    ...
    GetAlive: function (p, _a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                try {
                    db = new nedb_1.default({ filename: filename, autoload: true });
                    return [2 /*return*/, cp("ACK")];
                }
                catch (e) {
                    return [2 /*return*/, cp("Exception", new cessnalib.sys.Exception("Error occurred while initializing the Datastore"))];
                }
                return [2 /*return*/];
            });
        });
    ...
    ReadParticle: function (p, _a) {
        ...
        return new Promise(function (resolve) {
            var query = p.data.query;
            db.find(cessnalib.js.Class.toDotNotation(query), function (err, doc) {
                if (err)
                    return resolve(cp("Exception", new cessnalib.sys.Exception(JSON.stringify(err))));
                if (doc instanceof Array)
                    return resolve(cp("Particles", doc.map(function (d) {
                        delete d["_id"];
                        return d;
                    })));
    ...
    SaveParticle: function (p, _a) {
        ...
        return new Promise(function (resolve) {
            if (p.data instanceof Array) {
                ...
                if (query) {
                    if (count === "all") {
                        return db.update(cessnalib.js.Class.toDotNotation(query), particle, { upsert: true, multi: true }, function (err, doc) {
                            if (err)
                                return resolve(cp("Exception", new cessnalib.sys.Exception(JSON.stringify(err))));
                            return resolve(cp("ACK"));
                        });
                        ...
                        return db.update(cessnalib.js.Class.toDotNotation(query), particle, { upsert: true }, function (err, doc) {
                            if (err)
                                return resolve(cp("Exception", new cessnalib.sys.Exception(JSON.stringify(err))));
                            return resolve(cp("ACK"));
                        });
                    ...
                    return db.insert(particle, function (err) {
                        if (err)
                            return resolve(cp("Exception", new cessnalib.sys.Exception(JSON.stringify(err))));
                        return resolve(cp("ACK"));
                    });
    ...
    RemoveParticle: function (p, _a) {
        ...
        return new Promise(function (resolve) {
            ...
            if (count === "all") {
                db.remove(cessnalib.js.Class.toDotNotation(query), { multi: true }, function (err, doc) {
                    if (err)
                        return resolve(cp("Exception", new cessnalib.sys.Exception(JSON.stringify(err))));
                    return resolve(cp("ACK"));
                });
